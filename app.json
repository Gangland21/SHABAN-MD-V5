{
  "name": "SHABAN-MD-V5",
  "description": "Jᴀᴠᴀsᴄʀɪᴘᴛ Wʜᴀᴛsᴀᴘᴘ Bᴏᴛ Mᴀᴅᴇ Bʏ Mʀ Sʜᴀʙᴀɴ",
  ...
  "env": {
    "SESSION_ID": {
      ...
      "required": true,
      "value": "SHABAN-MD~k8BgVaxL#6OT4YZANU-jUdMQV6twiBzVXMJqpGSZ2CGqX7tRES0w"
    },  
 ...
 "AUTO_STATUS_REPLY": {
    ...
    "AUTO_STATUS_REACT": {
      "description": "status auto like or react make it true or false.",
      "required": false,
      "value": "true"
    }, 
